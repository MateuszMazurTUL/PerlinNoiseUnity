...
public class MapGenerator : MonoBehaviour {
    ...
    public void DrawMapInEditor() {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, terrainData.meshHeightMultiplier, terrainData.meshHeightCurve, editorPrevievLOD, terrainData.useFlatShading));
